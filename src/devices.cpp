...
pros::MotorGroup left_motors({-13, -5, -9}, pros::MotorGears::blue);
pros::MotorGroup right_motors({8, 15, 4}, pros::MotorGears::blue);

pros::MotorGroup intake_motor({-19, -18}, pros::MotorGears::blue);
...
pros::Rotation vert_tracking_wheel_rotation(-12);
